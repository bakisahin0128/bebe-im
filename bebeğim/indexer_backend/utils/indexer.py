...
class Indexer:
    ...
    def ingest_document(self, document):
        """
        Ingests a single document (page) into Azure Cognitive Search.

        Args:
            document (dict): The document to be indexed, containing pdf_name, page_number, content, and embedding.
        """
        self.create_index()
